  ...
  return (
    <div
      className={cn(
        ...
        isFullscreen
          ? timer.isOvertime
            ? "bg-gradient-to-br from-red-900 via-black to-orange-900 text-white animate-pulse"
            : "bg-black text-white"
            ...
            >
              ...
              <div className="mb-8 md:mb-12">
                <div
                  ...
                  style={{
                    textShadow: isFullscreen ? "0 0 80px rgba(0,0,0,0.5)" : "0 4px 20px rgba(0,0,0,0.1)",
                ...
                >
                  {timer.isOvertime ? (
                    <span className={cn("font-black", isFullscreen ? "text-red-400" : "text-red-500")}>
                      OVERTIME: +{formatTime(timer.minutes, timer.seconds)}
                    </span>
                  ) : timer.isRunning ? (
                    "FOCUS TIME"
                  ) : (
